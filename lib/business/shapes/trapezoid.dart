...
class Trapezoid extends BaseShape {
  ...
  Trapezoid({
    ...
    points.add(PointSystem(dx: 0, dy: 3, west: false, north: false));
    points.add(PointSystem(dx: 1, dy: 3));
    points.add(PointSystem(dx: 2, dy: 3, east: false, south: false));

//----
    points.add(PointSystem(dx: 1, dy: 2, west: false, north: false));
    points.add(PointSystem(dx: 2, dy: 2));
    points.add(PointSystem(dx: 3, dy: 2, east: false, south: false));

//---
    points.add(PointSystem(dx: 2, dy: 1, west: false, north: false));
    points.add(PointSystem(dx: 3, dy: 1));

    //----
    points.add(PointSystem(dx: 3, dy: 0, west: false, north: false));
  }
}
